...
import com.taxi.driver.utils.AllTripFeed;
import com.taxi.driver.utils.CircleTransform;
...
public class BookingDetailActivity extends AppCompatActivity implements FB_Callback {
    ...
    public void ShareFacebookLink(final String Description){
        ...
        if(loggedIn) {
            ...
            shareLink.postStatusUpdate("CarGo", Description, Url.AppLogUrl, "");
        }else{
    ...
    public void onResume() {
        ...
        IntentFilter filter = new IntentFilter("come.bits.bitsapp.BookingDetailActivity");
