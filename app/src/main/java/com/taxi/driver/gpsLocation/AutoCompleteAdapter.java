package com.taxi.driver.gpsLocation;
...
public class AutoCompleteAdapter extends ArrayAdapter implements Filterable {
    ...
    public static ArrayList autocomplete(String input,Activity activity) {
        ...
        StringBuilder jsonResults = new StringBuilder();
            ...
            String locationUrl = "";
            try {
                locationUrl = "https://maps.googleapis.com/maps/api/place/autocomplete/json?key=AIzaSyDelctTfQ_fd_Qn1TkFyueTdN38JBLBTA8&input=" + URLEncoder.encode(input, "UTF-8");
